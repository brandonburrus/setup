...
nnoremap ]c :echo "hi<" . synIDattr(synID(line("."),col("."),1),"name") . '> trans<'
...
Plug 'kballard/vim-swift'                         " Swift-specific improvements
...
" Disable the colo-column
setlocal colorcolumn=

" Undo any highlighting that might have been active
nohls
